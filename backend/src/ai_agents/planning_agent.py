...
critic_agent = Agent(
    ...
    instructions=(
        ...
        "9. Ensure the plan has sufficient breadth and depth for the task"
        "10. Check for consistency in terminology and naming conventions"
        "11. Ensure no task descriptions explicitly mention AI systems, ML algorithms, or robots as performers"
