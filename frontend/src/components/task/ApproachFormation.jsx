            ...
            <div className="space-y-6 mt-8">
                ...
                {approaches.approach_list.map((approach) => (
                    <div key={approach.approach_id} className="border rounded-lg p-4">
                        ...
                        {/* Resources */}
                        <div className="mt-4">
                            <h5 className="text-sm font-medium text-gray-500 mb-2">Required Resources</h5>
                            <ul className="list-disc list-inside space-y-1">
                        ...
                        {approaches.evaluation_criteria && approaches.evaluation_criteria.map((evaluation) => {
                            if (evaluation.approach_id === approach.approach_id) {
                                return (
                                    <div key={evaluation.approach_id} className="mt-4 border-t pt-4">
                                        <h5 className="text-sm font-medium text-gray-500 mb-3">Evaluation Scores</h5>
                                        <div className="grid grid-cols-3 gap-4">
                                            <div className="text-sm">
                                                <div className="font-medium">Ideality</div>
                                                <div className="text-gray-600">{evaluation.ideality_score.score}/10</div>
                                                <div className="text-xs text-gray-500 mt-1">{evaluation.ideality_score.reasoning}</div>
                                            </div>
                                            <div className="text-sm">
                                                <div className="font-medium">Feasibility</div>
                                                <div className="text-gray-600">{(evaluation.feasibility.score * 100).toFixed(0)}%</div>
                                                <div className="text-xs text-gray-500 mt-1">{evaluation.feasibility.reasoning}</div>
                                            </div>
                                            <div className="text-sm">
                                                ...
                                                <div className="text-xs text-gray-500 mt-1">{evaluation.resource_efficiency.reasoning}</div>
                                            </div>
                                        </div>
                                    </div>
                                );
